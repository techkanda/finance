    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Client Update Form</div>
                <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('password', '', array('placeholder' => 'Password','class' => 'form-control', 'autofocus')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('password_confirmation', null, array('placeholder' => 'Confirm Password','class' => 'form-control', 'autofocus')) !!}                                
                            </div>
                        </div>
